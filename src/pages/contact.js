  ...
  return (
    <Layout darkNavIcons={true} darkFooterBackground={true}>
      <Seo
        title="Get in Touch"
        description={
          "Have some feedback or want to reach out for potential business or advertising opportunities? Contact us here"
        }
      />
      ...
      <PostContentLayout includeRecentEditionsBar={false}>
        ...
        <p className={classes.text}>
          Have any feedback for how we could improve our site or include new
          types of content? Feel free to reach out! We're always happy to accept
          user feedback.
        </p>

        <p className={classes.text}>
          Our contact options are also open for potential business, advertisment
          and sponsorship offers as well! Please feel free to send us a message
          via the form below.
        </p>
