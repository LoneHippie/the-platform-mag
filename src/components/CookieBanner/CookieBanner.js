...
const CookieBanner = ({ darkFooterBackground }) => {
  ...
  useState(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      const consentCookie = cookiesList.hasOwnProperty(
  ...
  return (
    !bannerFlag && (
      ...
      >
        ...
        specified in the{" "}
        <a href="/cookies" style={{ color: "#026bbb" }}>
          cookie policy
        </a>
        . You can consent to the use of such technologies by using the “Accept
        All” button. By closing this notice, you continue without accepting.
      </CookieConsent>
    )
  );
};
